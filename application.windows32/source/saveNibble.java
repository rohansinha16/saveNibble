...
public class saveNibble extends PApplet {
...
public void gameSetup() {
    ...
    file = new SoundFile(this, "/Users/Home/Documents/Processing/saveNibble/assets/soundtrack/inGame.mp3");
    file.loop();
}
public void draw() {
    clear();
...
public void layout(int hintMode) {
...
class Button {
  ...
  public boolean mouseOver() {
    ...
    public void settings() {  size(650, 450);  smooth(); }
    static public void main(String[] passedArgs) {
        String[] appletArgs = new String[] { "saveNibble" };
        if (passedArgs != null) {
